                ...
                className="left w-full lg:w-1/2">
                    ...
                    <form action="" onSubmit={handleSubmit(onSubmit)}>
                        <div className='flex gap-9 mb-7'>
                            ...
                            <input className=' w-1/2 p-3  rounded-md shad  input text-gray-400  ' placeholder='Username' {...register('username')} type="text" required />
                            <input className=' w-1/2 p-3  rounded-md shad input text-gray-400 ' placeholder='Email' {...register('email')} type="email" required />
                        </div>
                        <input className='w-full p-3  rounded-md shad mb-7 input text-gray-400 ' placeholder='Subject' {...register('subject')} type="text" required />
                        <textarea className='w-full p-3  rounded-md shad h-32 mb-3 input text-gray-400 ' placeholder='Message' {...register('message')} required></textarea>
                        <Button type="submit" name={"Send"} icon={<TbSend2 className='bg-violet-700 icon' />} />
                    </form>
                </motion.div>
                <motion.div 
