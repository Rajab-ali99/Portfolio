  ...
  return (
    <>
      <Helmet>
        ...
        <div className=" relative  z-10 bg-[#1b252f] flex flex-col-reverse  lg:flex-row lg:flex  lg:px-[6%] py-10 lg:gap-14">
          {/* Background Video */}
          {showVideo && (
            <video
              autoPlay
        ...
        <div className="services py-5 px-[3%] lg:px-[8%]" >
          <div className=" lg:grid flex flex-col lg:grid-cols-3 lg:py-8  gap-6">
            ...
            <div className="box p-8 flex justify-center  flex-col bg-[#1b252f] cursor-pointer hover:shadow-md hover:shadow-violet-700 transition-all duration-300 rounded-xl">
              ...
              <h2 className='text-white font-semibold text-2xl text-center  py-3'>MERN Development</h2>
              <p className='text-gray-400  '>I am very familiar with NodeJS, Express JS, and MongoDB/Mongoose. So I can build full-stack application with MERN.</p>
            </div>
            <div className="box p-8 flex justify-center  flex-col bg-[#2b353f] cursor-pointer hover:shadow-md hover:shadow-violet-700 transition-all duration-300 rounded-xl">
              ...
              <h2 className='text-white font-semibold text-2xl text-center  py-3'>Web Design and Maintenance</h2>
              <p className='text-gray-400  '>I also provide Fully Responsive Static Website Design with Next js , React js ,Node js , Mongo Db HTML, CSS, Bootstrap, Tailwind, Matrial Ui , Chakra</p>
            </div>
            <div className="box p-9 flex justify-center  flex-col bg-[#1b252f] cursor-pointer hover:shadow-md hover:shadow-violet-700 transition-all duration-300 rounded-xl">
              <div className="logo flex justify-center "><svg className='text-violet-700 ' stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="3em" width="3em" xmlns="http://www.w3.org/2000/svg"><rect x="2" y="2" width="20" height="8" rx="2" ry="2"></rect><rect x="2" y="14" width="20" height="8" rx="2" ry="2"></rect><line x1="6" y1="6" x2="6.01" y2="6"></line><line x1="6" y1="18" x2="6.01" y2="18"></line></svg></div>
              <h2 className='text-white font-semibold text-2xl text-center  py-3'>Web Management</h2>
              <p className='text-gray-400  '>I will manage any kinds of website. Data Management, Component management, Bug Fixes and Service management and so on.
              </p>
            </div>
          </div>
        </div>
